...
public class Main_Innovative {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while (b) 
        {
            ...
            brea: 
            {
                // Register with name,username, password, phone and check if account already exist
                if (choice == 1) {
                    ...
                    System.out.println("Enter your preferd username : ");
                    String username = sc.nextLine();

                    File file = new File(FilePath + username + ".txt");
                    if (file.exists()) {
                        System.out.println("Sorry to say this but this Username has already been taken !");
                ...
                // Login with username and password
                    ...
                    char[] passwordArray = console.readPassword("Enter your secret password : (It is hidden due to security reasons....) \n");
                    String password = new String(passwordArray);
                    ...
                    if (file.exists()) {
                        try {
                            ...
                            if (username.equals(login_username) && password.equals(login_password)) {
                                ...
                                while (bo) {
                                    new ProcessBuilder("cmd", "/c", "cls").inheritIO().start().waitFor();
                                    System.out.println("\u001B[46m" + "Welcome " + login_name.toUpperCase() + " !"+ "		\u001B[0m");
                                    ...
                                    // Deposit Method
                                    if (choice2 == 1) {
                                        System.out.println("Enter Amount to Deposit : (Limit : 1 Lakh)");
                                        ...
                                        if (amount < 0 || amount > 100000) {
                                            ...
                                            try {
                                                ...
                                                Date date = new Date();
                                                f0.write("+ Rs." + temp +" -- "+formatter.format(date)+ " -- Deposit " + "\n");
                                    ...
                                    // Withdraw method
                                        ...
                                        if (amount_withdraw < 0 || amount_withdraw > login_money) {
                                            ...
                                            try {
                                                ...
                                                SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
                                                Date date = new Date();
                                                f0.write("- Rs." + temp1 +" -- "+formatter.format(date)+" -- Withdraw" + "\n");
                                    ...
                                    // Shwo all details from variables that we stored file contents
                                        ...
                                        System.out.println("5. Balance   : Rs." + login_money);
                                    ...
                                    // Transaction history (Show only if TRANSACTION:1 is there, Don't show if TRANSACTION:0 is there in file variable)
                                    else if (choice2 == 4) {
                                        try {
